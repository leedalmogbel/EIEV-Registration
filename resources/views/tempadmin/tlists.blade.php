    ...
    <div class="">
        ...
        <div class="mb-2">
            <div class="mt-3 form-floating">
                ...
                <select class="select-2-basic form-select col-12 text-center fs-5" style="height:75px;" name="eventid"
                    id="eventid">
            ...
            @if (count($stables) > 0)
                <div class="mt-1 form-floating">
                    <select class="stable-select select-2-basic form-select col-12 text-center fs-5" multiple="multiple"
                        style="height:75px;" name="stableid" id="stableid">
        ...
        @php
            $titles = ['final' => 'Final List', 'pfa' => 'Pending for Acceptance', 'prov' => 'Provisional Entries', 'royprov' => 'Royal Provisional Entries', 'pfr' => 'Pending for Review', 're' => 'Rejected/Withdrawn/Substituted Entries'];
        @endphp
                            ...
                            @foreach ($lists as $entry)
                                <tr>
                                    ...
                                    @if (!in_array($key, ['re', 'pdf', 'pfr']))
                                        <td class="text-center">
                                            <div>
                                                <a href="/rideslist/reject?entrycode={{ $entry->code }}"
                                                    class="btn btn-danger" id="reject-entry"><i
                                                        class="fa-solid fa-close"></i></a>
                                                @if (!Str::contains($key, 'final'))
                                                    @if (in_array($key, ['prov', 'royprov']))
                                                        <a href="/rideslist/mainlist?entrycode={{ $entry->code }}"
                                                            class="btn btn-success" id="move-entry"><i
                                                                class="fa-solid fa-check"></i></a>
                                                    @else
                                                        <a href="/rideslist/accept?entrycode={{ $entry->code }}"
                                                            class="btn btn-success" id="accept-entry"><i
                                                                class="fa-solid fa-check"></i></a>
                                                    @endif
                                                @endif
                                                <a href="/rideslist/withdraw?entrycode={{ $entry->code }}"
                                                    class="btn btn-main" id="withdraw-entry"><i
                                ...
                                <div class="row">
                                    <div class="col d-flex justify-content-end align-items-center gap-1">
                                        @foreach ($actions as $key => $value)
                                            @if ($key == 'reserved')
                                                <input type="checkbox" class="{{ $value['cname'] }}"
                                                    id={{ $key }}-action>
                                                <label for={{ $key }}-action>{{ $value['lbl'] }}</label>
                                            @else
                                                <button class="{{ $value['cname'] }}" type="button"
                                                    id={{ $key }}-action>{{ $value['lbl'] }}</button>
                                            @endif
                                        @endforeach
                                    </div>
                                </div>
                                        ...
                                        <div class={{ $item['cnames'][$i] }}>
                                            <div class="form-floating mb-3">
                                                @if ($item['flds'][$i] == 'startno')
                                                    ...
                                                    <input type="text" class="form-control uhide" disabled
                                                        id={{ $item['flds'][$i] }}>
    ...
    <script type="text/javascript">
        $(document).ready(function(e) {
            ...
            let final = $('#final').DataTable({
                ...
                buttons: [{
                        ...excel,
                        filename: `(Final List) ${f[eventval]}_admin`,
                        className: 'aexport',
                        text: 'Admin Excel',
                        exportOptions: {
                            columns: '.a-export'
                    ...
                    {
                        ...excel,
                        filename: `(Final List) ${f[eventval]}_media`,
                        className: 'mexport',
                        text: 'Media Excel',
                        exportOptions: {
                            columns: '.m-export'
                    ...
                    {
                        ...excel,
                        filename: `(Final List) ${f[eventval]}_timing`,
                        className: 'dexport',
                        text: 'Timing Excel',
                        exportOptions: {
                            columns: '.d-export'
                    ...
                    {
                        ...pdf,
                        filename: `(Final List) ${f[eventval]}`,
                        className: 'aexport',
                        text: 'PDF',
                        exportOptions: {
                            columns: '.a-export'
                        ...
                        customize: function(doc) {
                            ...
                            doc.fontSize = 8;
                            doc.pageMargins = 5;
                            doc.content[0].table.widths = Array.from({
                                length: $('.a-export').length / 5
                            }, (_, i) => 'auto');
            ...
            let pfa = $('#pfa').DataTable({
                ...
                buttons: [{
                        ...excel,
                        filename: `(For Acceptance List) ${f[eventval]}_admin`,
                        className: 'aexport',
                        text: 'Admin Excel',
                        exportOptions: {
                            columns: '.a-export'
                    ...
                    {
                        ...excel,
                        filename: `(For Acceptance List) ${f[eventval]}_media`,
                        className: 'mexport',
                        text: 'Media Excel',
                        exportOptions: {
                            columns: '.m-export'
                    ...
                    {
                        ...excel,
                        filename: `(For Acceptance List) ${f[eventval]}_timing`,
                        className: 'dexport',
                        text: 'Timing Excel',
                        exportOptions: {
                            columns: '.d-export'
                    ...
                    {
                        ...pdf,
                        filename: `(For Acceptance List) ${f[eventval]}`,
                        className: 'aexport',
                        text: 'PDF',
                        exportOptions: {
                            columns: '.a-export'
            ...
            let prov = $('#prov').DataTable({
                ...
                buttons: [{
                        ...excel,
                        filename: `(Provisional List) ${f[eventval]}_admin`,
                        className: 'aexport',
                        text: 'Admin Excel',
                        exportOptions: {
                            columns: '.a-export'
                    ...
                    {
                        ...excel,
                        filename: `(Provisional List) ${f[eventval]}_media`,
                        className: 'mexport',
                        text: 'Media Excel',
                        exportOptions: {
                            columns: '.m-export'
                    ...
                    {
                        ...excel,
                        filename: `(Provisional List) ${f[eventval]}_timing`,
                        className: 'dexport',
                        text: 'Timing Excel',
                        exportOptions: {
                            columns: '.d-export'
                    ...
                    {
                        ...pdf,
                        filename: `(Provisional List) ${f[eventval]}`,
                        className: 'aexport',
                        text: 'PDF',
                        exportOptions: {
                            columns: '.a-export'
            ...
            let royprov = $('#royprov').DataTable({
                ...
                buttons: [{
                        ...excel,
                        filename: `(Royal Provisional List) ${f[eventval]}_admin`,
                        className: 'aexport',
                        text: 'Admin Excel',
                        exportOptions: {
                            columns: '.a-export'
                    ...
                    {
                        ...excel,
                        filename: `(Royal Provisional List) ${f[eventval]}_media`,
                        className: 'mexport',
                        text: 'Media Excel',
                        exportOptions: {
                            columns: '.m-export'
                    ...
                    {
                        ...excel,
                        filename: `(Royal Provisional List) ${f[eventval]}_timing`,
                        className: 'dexport',
                        text: 'Timing Excel',
                        exportOptions: {
                            columns: '.d-export'
                    ...
                    {
                        ...pdf,
                        filename: `(Royal Provisional List) ${f[eventval]}`,
                        className: 'aexport',
                        text: 'PDF',
                        exportOptions: {
                            columns: '.a-export'
            ...
            let pfr = $('#pfr').DataTable({
                ...
                buttons: [{
                        ...excel,
                        filename: `(For Review List) ${f[eventval]}_admin`,
                        className: 'aexport',
                        text: 'Admin Excel',
                        exportOptions: {
                            columns: '.a-export'
                    ...
                    {
                        ...excel,
                        filename: `(For Review List) ${f[eventval]}_media`,
                        className: 'mexport',
                        text: 'Media Excel',
                        exportOptions: {
                            columns: '.m-export'
                    ...
                    {
                        ...excel,
                        filename: `(For Review List) ${f[eventval]}_timing`,
                        className: 'dexport',
                        text: 'Timing Excel',
                        exportOptions: {
                            columns: '.d-export'
                    ...
                    {
                        ...pdf,
                        filename: `(For Review List) ${f[eventval]}`,
                        className: 'aexport',
                        text: 'PDF',
                        exportOptions: {
                            columns: '.a-export'
            ...
            let re = $('#re').DataTable({
                ...
                buttons: [{
                        ...excel,
                        filename: `(Not Qualified List) ${f[eventval]}_admin`,
                        className: 'aexport',
                        text: 'Admin Excel',
                        exportOptions: {
                            columns: '.a-elim'
                    ...
                    {
                        ...excel,
                        filename: `(Not Qualified List) ${f[eventval]}_media`,
                        className: 'mexport',
                        text: 'Media Excel',
                        exportOptions: {
                            columns: '.m-export'
                    ...
                    {
                        ...excel,
                        filename: `(Not Qualified List) ${f[eventval]}_timing`,
                        className: 'dexport',
                        text: 'Timing Excel',
                        exportOptions: {
                            columns: '.d-export'
                    ...
                    {
                        ...pdf,
                        filename: `(Not Qualified List) ${f[eventval]}`,
                        className: 'aexport',
                        text: 'PDF',
                        exportOptions: {
                            columns: '.a-export'
