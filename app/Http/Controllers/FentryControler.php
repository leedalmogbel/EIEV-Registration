    ...
    public function fetchStartlist(Request $request)
    {
        ...
        $modifiedEntries = $entries->map(function ($entry) {
            $modifiedData = [
                ...
                'email' => $entry->userprofiles->email,
                'userid' => $entry->userid,
                'fname' => $entry->userprofiles->fname,
                'lname' => $entry->userprofiles->lname,
                'mobileno' => $entry->userprofiles->mobileno,
                'bday' => $entry->userprofiles->bday,
                'uniqueid' => $entry->userprofiles->uniqueid,
                'qrval' => $entry->qrval,
